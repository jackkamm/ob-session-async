...
It currently implements async session evaluation for R and Ruby, and
also provides functionality for implementing async session evaluation
in other language modes that use comint.
